...
exports.default = (db) => {
    ...
    router.post('/', (0, auth_1.authenticate)(db), async (req, res) => {
        ...
        try {
            ...
            await db.execute('INSERT INTO favorites (id, userId, officeId, createdAt) VALUES (?, ?, ?, ?)', [favoriteId, user.id, officeId, createdAt]);
    ...
    router.delete('/:officeId', (0, auth_1.authenticate)(db), async (req, res) => {
